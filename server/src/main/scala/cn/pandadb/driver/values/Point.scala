...
class Point2D(ss: Int, xx: Double, yy: Double) extends Point with Serializable {
  ...
  override def toString: String = "Point{" + "srid=" + srid + ", x=" + x + ", y=" + y +  '}'
}

class Point3D(ss: Int, xx: Double, yy: Double,zz: Double) extends Point with Serializable {
  override def srid: Int = ss
  ...
  override def toString: String = "Point{" + "srid=" + srid + ", x=" + x + ", y=" + y + ", z=" + z + '}'
}
